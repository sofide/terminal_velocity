...
class BotLogic:
    ...
    def go_to_position(self, postion_to_go, state):
        ...
        if state.power_distribution[ENGINES] < MAX_POWER:
            ...
            # maybe power is enough to add a shield
            shield_power = MAX_POWER - optimal_engines_power

            return self.power_action(engines=optimal_engines_power, lasers=0, shields=shield_power)
    ...
    def turn(self, turn_number, hp, ship_number, cargo, position, power_distribution, radar_contacts, leader_board):
        ...
        # add shields when there are enemies close
